...
public class LEx3 extends Fragment {
    ...
    private EditText editTextF1, editTextIntersection, editTextMonotonicity, editTextF2, editTextF3;
    ...
    public static LEx3 createInstance() {
        return new LEx3();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_l_ex3, container, false);
    ...
    private void fetchExerciseData() {
        ...
        db.collection("Exercises").document("LEx3")
                .get()

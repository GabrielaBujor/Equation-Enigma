...
public class REx2 extends Fragment {

    private TextView textViewTitle, textViewFunction, textViewInverseF, textViewParity, textViewBorders, textViewExtremePoints, textViewMonotonicityHint, textViewBijectivity, textViewConvexity;
    private EditText editTextEven, editTextOdd, editTextF0, editTextIntersection, editTextMonotonicity, editTextF1, editTextF32;
    ...
    public static REx2 createInstance() {
        return new REx2();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_r_ex2, container, false);
        ...
        editTextF32 = view.findViewById(R.id.editTextF32);
    ...
    private void fetchExerciseData() {
        ...
        db.collection("Exercises").document("REx2")
                .get()
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
                        ...
                        correctAnswers.put("f(32)", documentSnapshot.getString("f(32)"));
    ...
    private void verifyAnswers() {
        ...
        allCorrect &= checkAnswer(editTextF32, correctAnswers.get("f(32)"), "Incorrect answer");

...
public class REx3 extends Fragment {

    private TextView textViewTitle, textViewFunction, textViewParity, textViewBorders, textViewMonotonicityHint, textViewBijectivity, textViewConvexity;
    private EditText editTextF0, editTextIntersection, editTextMonotonicity, editTextF1, editTextF16;
    ...
    public static REx3 createInstance() {
        return new REx3();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_r_ex3, container, false);
        ...
        editTextF16 = view.findViewById(R.id.editTextF16);
    ...
    private void fetchExerciseData() {
        ...
        db.collection("Exercises").document("REx3")
                .get()
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
                        ...
                        correctAnswers.put("f(16)", documentSnapshot.getString("f(16)"));
    ...
    private void verifyAnswers() {
        ...
        allCorrect &= checkAnswer(editTextF16, correctAnswers.get("f(16)"), "Incorrect answer");

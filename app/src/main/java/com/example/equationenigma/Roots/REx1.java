...
public class REx1 extends Fragment {
    ...
    public static REx1 createInstance() {
        return new REx1();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_r_ex1, container, false);
    ...
    private void fetchExerciseData() {
        ...
        db.collection("Exercises").document("REx1")
                .get()
